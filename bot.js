...
function cpanel1() {
    return new Promise(resolve => {
        setTimeout(() => {
            client.channels.get(`550250704120315914`).setName(`KEYİFLİ SOHBETLER`);
            cpanel2();
        }, 10000);
      });
}
  ...
  function cpanel2() {
    return new Promise(resolve => {
        setTimeout(() => {
            client.channels.get(`550250704120315914`).setName(`DİLERİZ`);
            cpanel3();
        }, 10000);
      });
  }
  ...
  function cpanel4() {
    return new Promise(resolve => {
        setTimeout(() => {
            client.channels.get(`550250704120315914`).setName(`SUNUCUNA EKLEMEYİ UNUTMA!`);
            cpanel5();
        }, 10000);
      });
  }
  function cpanel5() {
    return new Promise(resolve => {
        setTimeout(() => {
            client.channels.get(`550250704120315914`).setName(`LokumS BOT DESTEK`);
            cpanel6();
        }, 10000);
      });
  }
  ...
  function cpanel7() {
    return new Promise(resolve => {
        setTimeout(() => {
            client.channels.get(`550250704120315914`).setName(`PREFİX [s!]`);
            cpanel8();
        }, 10000);
      });
  }
  function cpanel8() {
    return new Promise(resolve => {
        setTimeout(() => {
            client.channels.get(`550250704120315914`).setName(`EĞLENCELİ SOHBETLER`);
            cpanel9();
        }, 10000);
      });
  }
  ...
  function cpanel10() {
    return new Promise(resolve => {
        setTimeout(() => {
            client.channels.get(`550250704120315914`).setName(`LokumS BOT DESTEK SUNUCUSU`);
            cpanel11();
        }, 10000);
      });
  }
  function cpanel11() {
    return new Promise(resolve => {
        setTimeout(() => {
            client.channels.get(`550250704120315914`).setName(`RESMİ SUNUCUSU`);
            cpanel1();
        }, 10000);
      });
  }
...
.addField("Vote Atmak İstiyorsan Altaki Linke Tıkla Çabuk",`[Vote Atmak İçin Tıkla!](Şuan yok :c)`)
            .setColor("RANDOM")
    ...
    .then(channel =>
     ...
     .then(channel =>
      ...
      message.guild.createRole({
       ...
       message.channel.send("Silmeye uğraş")
...
client.on('message', msg => {
  if (msg.content.toLowerCase() === '<@515921456690102293>') {
    if (msg.guild.id == "515921456690102293") return;
        setTimeout(() => {
    }, 1000);//bekle
    msg.react('E')
    msg.react('Y')
    ...
    msg.reply('Botun Prefixi: s!yardım Yada s!help');
  }
});

client.on('message', message => {
    if (message.content.toLowerCase() === 's!köpek') {
...
client.on('message', message => {
    if (message.content.toLowerCase() === 's!kedi') {
var request = require('request');
...
client.on("message", async message => {
  ...
  if (curLevel > userData.level) {
    userData.level = curLevel;
        var user = message.mentions.users.first() || message.author;
message.channel.send(`🆙 **| ${user.username}   Bravo Level Atladın!** :up:`)
    }
...
message.channel.send(`📝 **| ${user.username} Adlı Kullanıcının Profili Burada!** :cool:`)
